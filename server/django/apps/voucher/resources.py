...
from .models import CreditNote, CreditNoteRow, DebitNote, DebitNoteRow, PurchaseVoucher, PurchaseVoucherRow, SalesVoucher, SalesVoucherRow
...
class PurchaseVoucherResource(PrettyNameModelResource):
    ...
    imported = Field(attribute="is_import", column_name="Import", widget=BooleanWidget())

    class Meta:
        model = PurchaseVoucher
        fields = ["id", "voucher_no", "date", "due_date", "party", "status", "mode", "bank_account", "discount_type", "discount", "trade_discount", "discount_obj", "remarks", "imported", "total_amount", "company", "user", "fiscal_year"]
        export_order = fields
...
class PurchaseVoucherRowResource(PrettyNameModelResource):
    ...
    trade_discount = Field(attribute="trade_discount", column_name="Trade Discount", widget=BooleanWidget())
    discount_obj = Field(attribute="discount_obj__name", column_name="Discount Object")
    ...
    class Meta:
        ...
        fields = ["id", "voucher", "item", "description", "quantity", "unit", "rate", "discount", "tax_amount", "discount_type", "trade_discount", "discount_obj", "tax_scheme", "discount_amount", "tax_amount", "net_amount", "company"]
        export_order = fields
