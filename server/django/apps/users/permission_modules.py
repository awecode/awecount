...
MODULES = [
    ...
    *gdp('PurchaseVoucher'), 'PurchaseVoucherCancel',
    ...
    *gdp('BankAccount'),
    *gdp('BankBranch'),
    *gdp('ChequeIssue'), 'ChequeIssueCancel',
    *gdp('FundTransfer'), 'FundTransferCancel',
    *gdp('ChequeDeposit'), 'ChequeDepositCancel',
    *gdp('BankCashDeposit'), 'BankCashDepositCancel',
    *gdp('SalesAgent'),
    *gdp('Widget'),
