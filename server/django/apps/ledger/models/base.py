...
from awecounting.libs import decimalize, none_for_zero, zero_for_none
from awecounting.libs.exception import BadOperation
...
def handle_company_creation(sender, **kwargs):
    ...
    secured_loans = Category.objects.create(
        name="Secured Loans",
        code="L-SL",
        parent=root["Liabilities"],
        company=company,
