  ...
  <q-form class="q-pa-lg" autofocus>
      ...
      <q-card class="q-mx-lg q-pt-md">
        <q-card-section>
          <div class="row q-col-gutter-md">
            ...
            <DatePicker class="col-md-6 col-12" label="Date *" v-model="fields.date" :error="!!errors?.date"
              :errorMessage="errors?.date" />
          </div>
        </q-card-section>
      </q-card>
      <ChallanTable v-if="formDefaults.collections" :itemOptions="formDefaults.collections ? formDefaults.collections.items : null
        " usedIn="purchase-order" :unitOptions="formDefaults.collections ? formDefaults.collections.units : null
    " v-model="fields.rows" :errors="!!errors.rows ? errors.rows : null"
      ...
      <div class="q-ma-md row q-pb-lg flex justify-end q-gutter-md">
        <q-btn :to="`/purchase-voucher/add/?purchase_order=${fields.voucher_no}&fiscal_year=${fields.fiscal_year}`"
          v-if="checkPermissions('ChallanCreate') && isEdit && fields.status === 'Issued'" color="blue"
          label="Issue Purchase Voucher" :loading="loading" />
