...
<template>
  <div class="q-pa-md">
    <div class="flex gap-4 justify-end">
      ...
      <q-btn v-if="checkPermissions('purchasevoucher.create')" color="green" :to="`/${$route.params.company}/purchase-voucher/create/`" label="New Purchase" icon-right="add" class="add-btn" />
    </div>
      ...
      <template #body-cell-actions="props">
        <q-td :props="props">
          ...
          <div v-if="checkPermissions('purchasevoucher.view')" class="row q-gutter-x-md items-center">
            <q-btn color="blue" label="View" :to="`/${$route.params.company}/purchase-voucher/${props.row.id}/view`" class="q-py-none q-px-md font-size-sm l-view-btn" style="font-size: 12px" data-testid="view-btn" />
          </div>
        </q-td>
        <!-- TODO: add modals -->
      </template>
      <template #body-cell-voucher_no="props">
        <q-td :props="props">
          <span v-if="props.row.voucher_no">
            <router-link v-if="checkPermissions('purchasevoucher.view')" :to="`/${$route.params.company}/purchase-voucher/${props.row.id}/view`" style="font-weight: 500; text-decoration: none" class="text-blue" data-testid="voucher-no">
