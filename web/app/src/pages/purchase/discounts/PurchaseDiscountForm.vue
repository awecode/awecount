    ...
    <q-card>
      ...
      <q-card class="q-mx-lg q-pt-md">
        ...
        <div class="text-right q-pr-md q-pb-lg">
          <q-btn v-if="checkPermissions('PurchaseDiscountCreate') && !isEdit" @click.prevent="submitForm" color="green" label="Create" class="q-ml-auto" type="submit" />
          <q-btn v-if="checkPermissions('PurchaseDiscountCreate') && isEdit" @click.prevent="submitForm" color="green" label="Update" class="q-ml-auto" type="submit" />
        </div>
      </q-card>
    </q-card>
  </q-form>
