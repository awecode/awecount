      ...
      <q-card class="q-mx-lg q-pt-md">
        <q-card-section>
          ...
          <div class="row q-col-gutter-md q-gutter-y-md">
            ...
            <div class="col-6">
              <n-auto-complete class="col-6 q-full-width" label="Tax Scheme" v-model="fields.default_tax_scheme_id"
                :options="formDefaults.collections?.tax_scheme" :modal-component="{}"
          ...
          <div class="row q-col-gutter-md q-gutter-y-md">
            <div class="col-6">
              <n-auto-complete class="col-6 q-full-width" label="Sales Account" v-model="fields.sales_account"
                :options="formDefaults.collections?.accounts" :modal-component="{}" :error="errors.sales_account" />
              <!-- TODO: add Unit Form  -->
            </div>
            <div class="col-6">
              <n-auto-complete class="col-6 q-full-width" label="Purchase Account" v-model="fields.purchase_account"
                :options="formDefaults.collections?.accounts" :modal-component="{}" :error="errors.purchase_account" />
            </div>
          </div>
          <div class="row q-col-gutter-md q-gutter-y-md">
            <div class="col-6">
              <n-auto-complete class="col-6 q-full-width" label="Discount Allowed Account"
                ...
                :modal-component="{}" :error="errors.discount_allowed_account" />
              <!-- TODO: add Unit Form  -->
            </div>
            <div class="col-6">
              <n-auto-complete class="col-6 q-full-width" label="Discount Received Account"
                v-model="fields.discount_received_account"
                :options="formDefaults.collections?.discount_received_account" :modal-component="{}"
          ...
          <div class="row q-gutter-y-lg q-mt-lg">
            ...
            <q-checkbox class="col-4" v-model="fields.can_be_purchased" label="Can be purchased?"
              ...
              :disable="fields.direct_expense || fields.indirect_expense" />
            <q-checkbox class="col-4" v-model="fields.fixed_asset" label="Fixed Asset?"
          ...
          <div class="row q-my-lg justify-between field-height">
            ...
            <div class="col-6 row item-center">
              <q-checkbox v-model="fields.use_account_subcategory" :label="
                fields.id
          ...
          <div>
            <div><span class="q-mr-md">Extra Fields</span><q-btn @click="addExtraFields"
                class="bg-primary text-white q-py-none q-px-sm" icon="add"></q-btn></div>
            <div v-if="fields.extra_fields?.length > 0">
              <div class="row q-gutter-x-md items-center" v-for="(field, index) in fields.extra_fields" :key="index">
                ...
                <q-select class="col-4" v-model="field.type" :options="extraFieldTypes" label="Type" />
