    ...
    <q-card>
      ...
      <q-card class="q-mx-lg q-pt-md">
        ...
        <div class="text-right q-pr-md q-pb-lg">
          <q-btn v-if="!isEdit && checkPermissions('AccountOpeningBalanceCreate')" :loading="loading" @click.prevent="submitForm"
            color="green" label="Create" class="q-ml-auto" type="submit" />
          <q-btn v-if="isEdit && checkPermissions('AccountOpeningBalanceModify')" :loading="loading" @click.prevent="submitForm"
