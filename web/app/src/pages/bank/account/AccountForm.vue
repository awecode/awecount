      ...
      <q-card class="q-mt-md q-ml-lg q-mr-lg q-mb-xs q-pt-md">
        <div class="q-px-sm">
          <div class="q-gutter-sm text-grey-8">
            <q-radio
              v-model="fields.is_wallet"
              :val="false"
              label="Bank Account, e.g. Standard Chartered"
            />
            <q-radio
              v-model="fields.is_wallet"
              :val="true"
              label="Wallet Account, e.g. eSewa, Paypal"
            />
          </div>
        </div>
        <q-card-section>
          ...
          <div class="row q-col-gutter-md q-mt-xs">
            <q-input
              ...
              :label="
                fields.is_wallet ? 'Wallet Name, e.g. Paypal' : 'Bank Name'
              "
              class="col-6"
          ...
          <div class="row col-6 q-col-gutter-md q-mt-xs">
            ...
            <q-input
              v-else
              v-model="fields.transaction_commission_percent"
