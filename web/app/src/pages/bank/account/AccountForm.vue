    ...
    <q-card>
      ...
      <q-card class="q-mt-md q-ml-lg q-mr-lg q-mb-xs q-pt-md">
        ...
        <div class="text-right q-pr-md q-pb-lg">
          <q-btn v-if="checkPermissions('BankAccountCreate') && !isEdit" color="green" label="Create" class="q-ml-auto" :loading="loading" @click.prevent="submitForm" type="submit" />
          <q-btn v-if="checkPermissions('BankAccountModify') && isEdit" color="green" label="Update" class="q-ml-auto" :loading="loading" @click.prevent="submitForm" type="submit" />
        </div>
      </q-card>
    </q-card>
  </q-form>
