<template>
  <div class="q-pa-md">
    <div class="row justify-between">
      <div></div>
      <q-btn color="green" to="/bank/cheque/cheque-issue/add/" label="New Cheque Issue" class="q-ml-lg" icon-right="add" />
    </div>

    <q-table title="Cheque Issues" :rows="rows" :columns="columns" :loading="loading" :filter="searchQuery" v-model:pagination="pagination" row-key="id" @request="onRequest" class="q-mt-md">
      ...
      <template v-slot:body-cell-actions="props">
        <q-td :props="props">
          ...
          <q-btn icon="edit" color="amber" dense flat :to="`/bank/cheque/cheque-issue/${props.row.id}/edit/`" />
          <!-- <q-btn
            icon="delete"
            color="red"
            dense
