          ...
          <div>
            ...
            <div v-for="row in reportData.values" :key="row.invoices__sales_agent_id" class="row q-pa-md" style="border-bottom: 2px solid lightgray">
              <div class="col-6 text-grey-8">
                <router-link :to="`/${$route.params.company}/payment-receipt/list?start_date=${fields.start_date}&end_date=${fields.end_date}&sales_agent=${row.invoices__sales_agent_id}`" target="_blank" style="text-decoration: none" class="text-blue">
