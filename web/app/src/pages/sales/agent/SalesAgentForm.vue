  ...
  <q-form class="q-pa-lg" autofocus>
    <q-card>
      ...
      <q-card-section>
        <div>
          <div class="row">
            <q-input v-model="fields.name" label="Name *" class="col-12 col-md-6" :error="!!errors.name"
              :error-message="errors.name"></q-input>
          </div>
          <div class="row">
            <q-input v-model.number="fields.compensation_multiplier" label="Compensation Multiplier *" type="number"
              class="col-12 col-md-6" :error="!!errors.compensation_multiplier"
              :error-message="errors.compensation_multiplier"></q-input>
          </div>
        </div>
      </q-card-section>
