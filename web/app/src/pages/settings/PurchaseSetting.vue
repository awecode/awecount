          ...
          <div class="row q-ml-sm">
            <div class="col-12 col-sm-6">
              <n-auto-complete-v2 label="Mode" v-model.number="fields.payment_mode" :options="modeOptionsComputed"
                :endpoint="`v1/${route.params.company}/purchase-settings/create-defaults/payment_modes`" :staticOption="fields.selected_mode_obj"
                option-value="id" option-label="name" map-options emit-value :error="!!modeErrors"
                :error-message="modeErrors">
                <template v-slot:append>
...
export default {
  setup() {
    ...
    const $q = useQuasar()
    const endpoint = `v1/${route.params.company}/purchase-settings/`
