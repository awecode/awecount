<template>
  <div class="grid lg:grid-cols-2 lg:gap-4">
    ...
    <div>
      <n-auto-complete-v2 v-if="type === 'existing'" class="q-full-width" :label="`${label} Account`" v-model="modalValue" :options="props.options" :endpoint="endpointLabelMap[props.label]" :modal-component="checkPermissions('AccountCreate') ? LedgerForm : null" :error="error" :staticOption="injectOption" />
