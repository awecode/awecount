  ...
  <div class="print-only">
    <div v-if="store.companyInfo.invoice_template == 1">
      <div style="position: relative; margin-bottom: 10px">
        <img v-if="store.companyInfo.logo_url" :src="store.companyInfo.logo_url" alt="Compony Logo" style="
            height: 110px;
            object-fit: contain;
            max-width: 160px;
            position: absolute;
        ...
        <div style="text-align: center; padding-left: 10px">
          <h1 style="
            ...
            {{
      store.companyInfo.organization_type === 'private_limited'
        ? ' Pvt. Ltd.'
        : ['public_limited', 'corporation'].includes(
          store.companyInfo.organization_type
        )
          ? 'Ltd.'
          : ''
    }}
          ...
          <div style="font-size: 14px">
            <div style="
              ...
              <div style="
                  ...
                  justify-content: center;
                ">
                <span>Email: {{ store.companyInfo.emails && store.companyInfo.emails.length ?
      ...
      <div style="
        ...
        <div style="
          ...
          ">
          <div style="font-size: 14px">
            VAT No. <strong>{{ store.companyInfo.tax_registration_number }}</strong>
          </div>
          <div v-if="store.companyInfo.website" class="flex items-center">
            <img src="/icons/web-fill.svg" alt="Website" style="margin-right: 10px; width: 14px" /><span
              style="color: skyblue">{{ store.companyInfo.website }}</span>
          </div>
        </div>
      </div>
    </div>
      ...
      store.companyInfo.organization_type === 'private_limited'
        ...
        ">
          <div style="margin-bottom: 5px;">
            <img :src="store.companyInfo.logo_url" alt="Compony Logo"
          ...
          <div style="display: flex; align-items: center">
            <img src="/icons/envelope-fill.svg" alt="Email" style="margin-right: 10px; width: 14px" /><span
