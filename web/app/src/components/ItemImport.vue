    ...
    <q-card>
      ...
      <q-card-section>
        <q-form @submit="onSubmit()">
          ...
          <q-file v-model="file" name="file" style="max-width: 400px" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel,text/comma-separated-values, text/csv, application/csv" label="Select File"></q-file>
          <div class="q-mt-md">
            <q-checkbox v-model="createNewCategory" label="Create New Category?"></q-checkbox>
          ...
          <div class="q-mt-md">
            <q-checkbox v-model="createNewUnit" label="Create New Unit?"></q-checkbox>
            <q-icon color="grey-6" name="info" size="sm">
