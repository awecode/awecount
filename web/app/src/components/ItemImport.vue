        ...
        <q-card>
            ...
            <q-card-section>
                <q-form @submit="onSubmit()">
                    ...
                    <div class="q-mt-md">
                        <q-checkbox v-model="createNewUnit" label="Create New Unit?"></q-checkbox> <q-icon
                            color="grey-6" name="info" size="sm"
                            title="Enabling this creates new Unit with the give name if it does not exist."></q-icon>
                    </div>
