    ...
    <q-card>
      ...
      <q-card-section>
        <q-form @submit="onSubmit()">
          ...
          />
          <div class="q-mt-md">
            <q-checkbox v-model="createNewCategory" label="Create New Category?" /> <q-icon
              color="grey-6"
              name="info"
              size="sm"
            >
          ...
          <div class="q-mt-md">
            <q-checkbox v-model="createNewUnit" label="Create New Unit?" /> <q-icon
              color="grey-6"
              name="info"
              size="sm"
            >
          ...
          <q-btn :loading="loading" :disable="!file" color="green" type="submit" class="q-mt-lg">
            Upload
          </q-btn>
        </q-form>
      </q-card-section>
