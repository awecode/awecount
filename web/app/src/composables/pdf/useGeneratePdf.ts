...
${table}
<div style="${invoiceInfo.received_by && invoiceInfo.received_by !== '<br>'  ? 'text-align: left' : 'display: none;'}">
  <span style="font-weight: 600; color: grey;">Received By: </span> <br> ${invoiceInfo.received_by}
</div>
<div style="margin: 20px 0; text-align: left; ${invoiceInfo.invoice_footer_text ? '' : 'display: none;'}">${invoiceInfo.invoice_footer_text}
</div>
