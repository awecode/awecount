  ...
  <div class="q-pa-md">
    <div class="q-px-md q-pb-md">
      <div class="flex items-center justify-end q-gutter-x-md q-gutter-y-xs">
        ...
        <div v-if="showData" class="flex q-gutter-x-md q-gutter-y-xs">
          ...
          <q-btn color="green" icon-right="download" label="Export Xls" @click="onDownloadXls" />
        </div>
      </div>
    </div>
    <div class="flex q-gutter-x-sm flex no-wrap">
        ...
        <q-markup-table id="tableRef">
            ...
            <tr v-if="showData" class="bg-grey-2">
              ...
              <th v-for="(timeperoid, index) in timePeriodArray" :key="index">
                ...
                <div class="flex">
                  ...
                  <q-btn v-if="accounts.length > 0" dense flat class="q-ml-md" color="red-5" size="sm" title="Delete Column" @click="onRemoveColumn(index)">
          ...
          <tbody>
            <template v-if="showData">
              <BalanceSheetTableNode :accounts="accounts" :category_accounts="category_accounts" :config="config" :is-asset="true" :item="categoryTree[0]" :root="true" />
              <BalanceSheetTableNode :accounts="accounts" :category_accounts="category_accounts" :config="config" :item="categoryTree[1]" :root="true" />
              <BalanceSheetTableNode :accounts="accounts" :category_accounts="category_accounts" :config="config" :item="categoryTree[4]" :root="true" />
            </template>
            <tr v-if="!showData">
      ...
      <div style="width: 30px">
        <q-btn class="m-none q-pa-sm" color="green" icon="add" title="Add Column">
          <q-menu>
            <div class="menu-wrapper" style="width: min(300px, 90vw)">
              <div style="border-bottom: 1px solid lightgrey">
